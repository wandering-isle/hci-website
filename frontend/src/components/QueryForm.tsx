 ...
 * @param setting info on the scene of the discusison
...
const formatString = (
  ...
  return (
    ...
    additional +
    "] and know that you are currently at ["+setting+"]."
  );
};
...
const QueryForm = () => {
  ...
  const onSubmit = (data: FieldValues) => {
    ...
    const { request, cancel } = createResponseService().postMessages([
      {
        role: "user",
        content: formatString(data.subject, data.modifier, data.additional, data.setting),
      },
    ]);
